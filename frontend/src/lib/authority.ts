 ...
 * legal-identity fields — RateConfirmationModal.tsx (RC form's
 * SRL_INFO block that pre-fills the rate-con header).
 *
 * v3.8.awu: BOLTemplate.tsx was the other consumer and is gone. It was a
 * second, client-side renderer for the bill of lading; the authoritative BOL
 * is generated by pdfService from backend/src/config/authority.ts.
 *
