...
export interface BlockedCode {
  code:
    ...
    // v3.8.beh — NINTH absolute (seventh when written; carrier-archive B2a
    // landed two ahead of it). Never signed is the same fact as terminated with a
    // weaker excuse: no contract governs the load. The remedy is a signature.
    | "AGREEMENT_MISSING"
