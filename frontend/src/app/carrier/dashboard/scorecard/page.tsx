    ...
    <div>
      ...
      <CarrierCard className="mb-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="font-semibold text-[#0D1B2A] text-sm">Milestones</h2>
        ...
        <div className="bg-[#C9A84C]/5 border border-[#C9A84C]/15 rounded-xl p-4 mb-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <div className="text-sm font-bold text-[#0D1B2A]">{currentMilestone.name}</div>
        ...
        {nextMilestoneObj && (
          <div className="mb-4">
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-xs font-semibold text-[#0D1B2A]">Progress to {nextMilestoneObj.id}: {nextMilestoneObj.name}</span>
            ...
            {MILESTONES.map((m, i) => {
              ...
              return (
                <div key={m.id} className="flex flex-col items-center flex-1">
                  ...
                  <span className={`text-[9px] mt-1 text-center leading-tight ${isCurrent ? "font-bold text-[#0D1B2A]" : "text-gray-400"}`}>
                    {m.name}
                  </span>
                </div>
              );
