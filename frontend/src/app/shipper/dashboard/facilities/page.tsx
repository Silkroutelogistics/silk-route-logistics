...
const typeColors: Record<string, { bg: string; text: string }> = {
  Origin: { bg: "bg-[#E2EAF2]", text: "text-[#2A5B8B]" },
  Destination: { bg: "bg-[#E6F0E9]", text: "text-[#2F7A4F]" },
  Both: { bg: "bg-[#E2EAF2]", text: "text-[#2A5B8B]" },
};
          ...
          return (
            <ShipperCard key={i} hover padding="p-5">
              <div className="flex justify-between mb-3">
                <h3 className="text-[15px] font-bold text-[#0A2540]">{f.name}</h3>
