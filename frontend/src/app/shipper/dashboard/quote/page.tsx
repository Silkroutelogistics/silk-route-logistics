...
export default function ShipperQuotePage() {
  return (
    <div>
      <h1 className="font-serif text-2xl text-[#1a1a2e] mb-1">Request a Freight Quote</h1>
      ...
      <div className="grid grid-cols-[2fr_1fr] gap-6">
        ...
        <div>
          <ShipperCard padding="p-5" className="mb-4">
            <h4 className="text-[13px] font-bold text-[#1a1a2e] mb-3">Quick Templates</h4>
            {[
              ...
              <div key={i} className="p-3 rounded-md border border-gray-200 cursor-pointer mb-2 hover:border-[#C9A84C]/30 transition-colors">
                <div className="text-xs font-semibold text-[#1a1a2e]">{t.name}</div>
                <div className="text-[11px] text-gray-400">{t.equip}</div>
              </div>
            ))}
          </ShipperCard>
          <ShipperCard padding="p-5" className="!bg-[#1a1a2e] !border-transparent">
