            ...
            <div className="mb-8 pb-6 border-b border-gray-200">
              ...
              <div className="space-y-3 max-w-md">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0D1B2A] text-white text-xs font-semibold rounded-md disabled:opacity-50"
                >
                ...
                <div>
                  ...
                  {showDisable ? (
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 bg-gray-100 text-[#0D1B2A] text-xs font-semibold rounded-md hover:bg-gray-200"
                    >
                      Disable 2FA
                    </button>
                  )}
                ...
                <div className="space-y-4 max-w-md">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-br from-[#C9A84C] to-[#A88535] text-[#0D1B2A] text-xs font-semibold uppercase tracking-[1.5px] rounded shadow-[0_4px_20px_rgba(201,168,76,0.3)] disabled:opacity-50"
                    >
