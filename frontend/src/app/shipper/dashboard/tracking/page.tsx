    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        <ShipperCard padding="p-4">
          ...
          <p className="text-xl font-bold text-[#0F1117]">{isLoading ? "—" : active.length}</p>
        </ShipperCard>
        <ShipperCard padding="p-4">
          <div className="flex items-center gap-2 mb-1">
          ...
          <p className="text-xl font-bold text-[#0F1117]">{isLoading ? "—" : active.filter(s => s.status === "IN_TRANSIT").length}</p>
        </ShipperCard>
        <ShipperCard padding="p-4">
          <div className="flex items-center gap-2 mb-1">
          ...
          <p className="text-xl font-bold text-[#0F1117]">{isLoading ? "—" : active.filter(s => s.riskLevel === "GREEN").length}</p>
        </ShipperCard>
        <ShipperCard padding="p-4">
          <div className="flex items-center gap-2 mb-1">
