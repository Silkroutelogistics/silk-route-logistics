      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 flex-shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Avatar */}
            <div className="w-[34px] h-[34px] rounded-full bg-gradient-to-br from-[#0F1117] to-[#1B2D45] flex items-center justify-center text-xs font-bold text-[#C9A84C] border-2 border-[#C9A84C]/30 cursor-pointer">
              {initials}
            </div>
          </div>
        </header>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[99999] flex items-center justify-center">
          <div className="bg-[#121e30] border border-[rgba(200,150,62,0.2)] rounded-2xl p-9 max-w-[420px] w-[90%] text-center shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
            ...
            <div className="flex gap-3 justify-center">
              <button onClick={extendSession} className="px-6 py-2.5 text-sm font-semibold bg-gradient-to-br from-[#c8a951] to-[#b8963e] text-[#0F1117] rounded-lg hover:shadow-[0_4px_20px_rgba(200,150,62,0.25)] transition-all">
                Extend Session
              </button>
