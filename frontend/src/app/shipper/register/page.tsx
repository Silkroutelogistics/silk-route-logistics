        ...
        <div className="max-w-[640px] mx-auto px-6 py-16">
          <div className="bg-white rounded-md border border-gray-200 p-9 text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-[#C9A84C] to-[#A88535] text-[#0F1117] text-xs font-semibold uppercase tracking-[2px] rounded shadow-[0_4px_20px_rgba(201,168,76,0.3)] hover:-translate-y-0.5 transition-all"
            >
    ...
    <div className="bg-[#F8F5ED] min-h-screen">
      ...
      <div className="max-w-[640px] mx-auto px-6 py-12">
          ...
          {steps.map((s, i) => (
            <div key={i} className="flex items-center">
              <div className="flex flex-col items-center gap-1.5">
                ...
                <span className={`text-[10px] ${step === i + 1 ? "text-[#0F1117] font-semibold" : "text-gray-400"}`}>{s}</span>
              </div>
        ...
        <div className="bg-white rounded-md border border-gray-200 p-9">
          {step === 1 && (
            <>
              <h2 className="font-serif text-2xl text-[#0F1117] mb-1">Company Information</h2>
          ...
          {step === 2 && (
            <>
              <h2 className="font-serif text-2xl text-[#0F1117] mb-1">Shipping Profile</h2>
          ...
          {step === 3 && (
            <>
              <h2 className="font-serif text-2xl text-[#0F1117] mb-1">Preferences &amp; Security</h2>
          ...
          {step === 4 && (
            <>
              <h2 className="font-serif text-2xl text-[#0F1117] mb-1">Review &amp; Submit</h2>
              ...
              {[
                ...
                <div key={i} className={`flex justify-between py-2.5 ${i < 8 ? "border-b border-gray-100" : ""}`}>
                  ...
                  <span className="text-[13px] font-semibold text-[#0F1117]">{v || "—"}</span>
                </div>
              ))}
          ...
          <div className="flex justify-between mt-7 gap-3">
            ...
            {step < 4 ? (
              <button onClick={() => setStep(step + 1)} className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-[#C9A84C] to-[#A88535] text-[#0F1117] text-xs font-semibold uppercase tracking-[2px] rounded shadow-[0_4px_20px_rgba(201,168,76,0.3)] hover:-translate-y-0.5 transition-all">
                <ArrowRight size={16} /> Continue
              </button>
            ) : (
              <button onClick={handleSubmit} disabled={submitting} className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-[#C9A84C] to-[#A88535] text-[#0F1117] text-xs font-semibold uppercase tracking-[2px] rounded shadow-[0_4px_20px_rgba(201,168,76,0.3)] hover:-translate-y-0.5 transition-all disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0">
                {submitting ? (
