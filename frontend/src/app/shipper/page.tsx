...
export default function ShipperLandingPage() {
  return (
    <div className="bg-[#F8F5ED] min-h-screen">
      {/* Nav */}
      <nav className="sticky top-0 z-[100] bg-[#0F1117]/92 backdrop-blur-xl border-b border-[#C9A84C]/15">
        <div className="max-w-[1280px] mx-auto px-8 flex items-center justify-between h-[76px]">
          <Link href="/shipper" className="flex items-center gap-3.5">
            <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#C9A84C] to-[#A88535] flex items-center justify-center text-lg font-extrabold text-[#0F1117] shadow-[0_2px_12px_rgba(201,168,76,0.3)]">
              SR
            </div>
            <div>
          ...
          <div className="flex gap-2">
            ...
            <Link href="/shipper/register" className="px-4 py-2 bg-gradient-to-br from-[#C9A84C] to-[#A88535] text-[#0F1117] text-[11px] font-semibold uppercase tracking-[2px] rounded shadow-[0_4px_20px_rgba(201,168,76,0.3)] hover:shadow-[0_6px_30px_rgba(201,168,76,0.45)] hover:-translate-y-0.5 transition-all">
              Get Started
            </Link>
          </div>
        </div>
      ...
      {/* Hero */}
      <section className="bg-[#0F1117] min-h-screen flex items-center px-8 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[200px] bg-gradient-to-t from-[#0F1117] to-transparent pointer-events-none" />
      ...
      <section className="py-[100px] px-8 max-w-[1280px] mx-auto">
        <div className="text-center mb-14">
          ...
          <h2 className="font-serif text-[32px] text-[#0F1117] mb-3">Complete Freight Management for Shippers</h2>
            ...
            return (
              <div key={i} className="bg-white rounded-md border border-gray-200 p-7 hover:border-[#C9A84C]/30 hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-all">
                <div className="flex justify-between items-start mb-4">
                  <div className="w-12 h-12 rounded-md bg-[#0F1117] flex items-center justify-center">
                ...
                <h3 className="text-base font-bold text-[#0F1117] mb-2">{f.title}</h3>
      ...
      {/* Comparison */}
      <section className="bg-[#0F1117] py-[100px] px-8">
      ...
      {/* CTA */}
      <section className="py-[100px] px-8 text-center bg-gradient-to-br from-[#0F1117] to-[#060F1A] relative overflow-hidden">
