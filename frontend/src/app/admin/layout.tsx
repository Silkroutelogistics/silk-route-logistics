...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (user?.role !== "ADMIN") {
    return (
      <div className="flex items-center justify-center min-h-screen" style={{ background: 'var(--srl-bg-base)', color: 'var(--srl-text)' }}>
  ...
  return (
    <div className="flex min-h-screen" style={{ background: 'var(--srl-bg-base)', color: 'var(--srl-text)' }}>
      {/* Admin Sidebar */}
