    ...
    <div className="p-4 lg:p-6 h-[calc(100vh-2rem)] flex flex-col gap-0">
      ...
      <div className="flex-1 flex flex-col gap-0 min-h-0">
        ...
        {confirmingAssign && selectedLoad && selectedCarrier ? (
          ...
          <div className="shrink-0 h-1 bg-gradient-to-r from-[#C9A84C]/20 via-[#1a2d47] to-[#1a2d47]" />
        )}
        ...
        <div className="flex-1 min-h-0 flex flex-col bg-white/5 border border-white/10 rounded-b-xl overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 shrink-0 bg-gradient-to-r from-blue-500/10 to-transparent">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <option value="" style={{ backgroundColor: "#0f172a", color: "#f8fafc" }}>All Equipment</option>
                <option value="Dry Van" style={{ backgroundColor: "#0f172a", color: "#f8fafc" }}>Dry Van</option>
                <option value="Reefer" style={{ backgroundColor: "#0f172a", color: "#f8fafc" }}>Reefer</option>
                <option value="Flatbed" style={{ backgroundColor: "#0f172a", color: "#f8fafc" }}>Flatbed</option>
                <option value="Step Deck" style={{ backgroundColor: "#0f172a", color: "#f8fafc" }}>Step Deck</option>
              </select>
              <div className="relative">
                <Search className="absolute left-2.5 top-2 w-3.5 h-3.5 text-slate-500" />
                <input
