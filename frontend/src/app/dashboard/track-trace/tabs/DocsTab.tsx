...
export function DocsTab({ load, loadId, onChange }: Props) {
  ...
  // v3.8.awt — see the twin in crm/tabs/DocsTab.tsx. Hook called before the
  // early return so its order is stable; s3:// fileUrl replaced by a blob: URL
  // served from the API, which is the only scheme frame-src allows here.
