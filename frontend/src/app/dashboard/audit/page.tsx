        ...
        <>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <select value={actionFilter} onChange={(e) => { setActionFilter(e.target.value); setPage(1); }}
              ...
              <option value="" className="bg-[#0f172a] text-white">All Actions</option>
              {uniqueActions.map((a) => (
                <option key={a} value={a} className="bg-[#0f172a] text-white">{a}</option>
              ))}
            </select>
            <select value={entityFilter} onChange={(e) => { setEntityFilter(e.target.value); setPage(1); }}
              ...
              {uniqueEntities.map((e) => (
                <option key={e} value={e} className="bg-[#0f172a] text-white">{e}</option>
              ))}
            </select>
          </div>
