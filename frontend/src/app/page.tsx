    ...
    <main className="min-h-screen bg-navy text-white">
      ...
      <nav className="flex items-center justify-between px-6 md:px-12 py-5 max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            <p className="text-lg font-semibold leading-tight">Silk Route Logistics</p>
            <p className="text-xs text-slate-400">Your Trusted Partner in North American Freight</p>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">Modern, well-maintained equipment to handle any freight requirement across North America.</p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {fleet.map((f) => (
            <div key={f.type} className="p-6 rounded-2xl bg-navy-light border border-white/5 text-center">
              <p className="text-3xl font-bold text-gold mb-1">{f.count}</p>
              <p className="font-semibold mb-2">{f.type}</p>
      ...
      <section className="bg-navy-light py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">Comprehensive freight solutions tailored to your supply chain needs.</p>
          </div>
          <div className="grid sm:grid-cols-2 gap-6">
            {services.map((s) => {
              const Icon = s.icon;
              return (
                <div key={s.title} className="p-6 rounded-2xl border border-white/5 hover:border-gold/30 transition group">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-24">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose Silk Route</h2>
          <p className="text-slate-400 max-w-2xl mx-auto">Built on trust, powered by technology, driven by performance.</p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {whyUs.map((w) => {
            const Icon = w.icon;
      ...
      <section className="bg-navy-light py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Carrier Performance Tiers</h2>
            ...
            {[
              ...
              <div key={t.name} className="rounded-2xl border border-white/10 overflow-hidden">
                ...
                <div className="p-5 space-y-3">
                  <div><p className="text-xs text-slate-500 uppercase">Bonus</p><p className="text-2xl font-bold text-gold">{t.bonus}</p></div>
                  <div><p className="text-xs text-slate-500 uppercase">Perks</p><p className="text-sm text-slate-300">{t.perks}</p></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-24 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Partner with Silk Route?</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <Logo size="sm" />
              <span className="font-semibold">Silk Route Logistics</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-slate-400">
              <div className="flex items-center gap-2"><MapPin className="w-4 h-4 text-gold shrink-0" /><span>123 Logistics Blvd, Mississauga, ON L5T 2M7</span></div>
              <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-gold shrink-0" /><span>+1 (905) 555-0100</span></div>
            ...
            <div className="flex gap-3 mt-4">
              {["LinkedIn", "X", "FB"].map((s) => (
                <span key={s} className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-xs text-slate-400 hover:bg-gold/20 hover:text-gold transition cursor-pointer">{s[0]}</span>
              ))}
            </div>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 md:px-12 mt-8 pt-8 border-t border-white/5">
          <p className="text-sm text-slate-600 text-center">&copy; 2026 Silk Route Logistics Inc. All rights reserved.</p>
        </div>
      </footer>
    </main>
  );
