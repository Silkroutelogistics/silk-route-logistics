          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="pb-4 border-b border-[#EFE6D3]">
                ...
                <p className="text-sm text-[#3A4A5F] leading-relaxed">Confirm everything looks right before submission. The Compass Engine begins its 33-point check immediately on submit.</p>
              </div>
