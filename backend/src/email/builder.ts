...
Compass Engine is our 33-point carrier vetting system. For reefer freight the load-bearing checks are unit age, last PM date, calibration certificate currency, and historical temp-compliance scores.
...
Compass Engine is our 33-point carrier vetting system. For premium retail freight the load-bearing checks are claims ratio, inspection history, and on-time-in-full at retailer DCs.
...
Compass Engine is our 33-point carrier vetting system. Every carrier in our network clears equipment age, brake performance, claims ratio, and on-time-in-full at retailer DCs before hauling a load.
...
Every carrier in our network passes a 33-point compliance check before hauling their first load. For food-grade shipments, that includes reefer certification, temperature monitoring history, and clean inspection records.
