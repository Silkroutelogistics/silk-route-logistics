...
const BASE_CURRICULUM: CurriculumCourse[] = [
  // ─────────────────────────────────────────────────────────
  {
    ...
    summary: "The federal Hours of Service limits, the four duty statuses, the short-haul and 16-hour exceptions, the adverse-driving exception, how your ELD records duty status, sleeper-berth splits, and what to do when the device fails.",
    version: "5",
    estMinutes: 30,
    passThreshold: 80,
    validityMonths: 12,
...
**At a roadside inspection.** When an officer asks for your logs, you present or transfer your record of duty status — either on the ELD's own display or printout (the local method) or by an electronic data transfer (the telematics method). Depending on your device, that transfer is done by **email, USB drive, Bluetooth, or web services**. Know which method your ELD uses before you are standing at the window.

**Pre-select Personal Conveyance and Yard Move.** These are special driving categories your ELD supports, but you must **select them BEFORE you start moving** — you cannot apply them after the fact. Drive first and try to reclassify later, and that time is already logged as regular driving.
...
You are responsible for selecting the correct duty status: off duty, sleeper berth, driving, or on-duty-not-driving. The device records the driving; you annotate the rest. Review and certify your logs every day. Driving the truck without logging in shows up as Unidentified Driver time that you must review and accept or reject. You, not the carrier, approve any edits to your record, and a carrier may never push you to certify a log you know is false. Uncertified logs and unassigned driving time are easy roadside findings.`,
      },
      {
        ...
        estMinutes: 5,
        bodyMarkdown:
          "**ELD malfunction.** If your ELD fails, note the malfunction, and you may keep paper logs for up to 8 days. Reconstruct your record of duty status for the current 24-hour period and the prior 7 days. Notify your carrier (generally within 24 hours); the carrier must repair or replace the device within 8 days.\n\n**Personal conveyance (PC).** This is off-duty movement of the truck for your own personal purpose, not advancing the load. It does not consume driving hours, but it must be **genuinely off-duty** — and whether the truck is laden (loaded) or unladen (empty) does not matter, so long as the movement is truly personal.\n\n- **ALLOWED as PC:** moving to the nearest safe rest area or parking after you have been loaded, or after a shipper or receiver directs you to leave their property; driving from the dock to a nearby truck stop to rest; travel between your terminal and your lodging.\n- **NOT ALLOWED as PC:** driving to enhance operational readiness — for example, repositioning closer to your next shipper so you can pick up sooner, or moving the truck to save time on tomorrow's dispatch. If the movement advances the load or the business in any way, it is driving, not PC.\n\nMisusing PC to make up driving time is one of the most common ELD violations.\n\n**Yard moves.** Moving the truck within a private yard or terminal is recorded as on-duty-not-driving (a special driving category), not as line-haul driving.\n\nThe most common roadside HOS violations are exceeding the 11 or 14-hour limits, missing the 30-minute break, false logs, and form-and-manner errors. Exceeding the 11-hour, 14-hour, or 60/70-hour limit is an out-of-service violation: the inspector parks you and the truck until you have the hours to be legal again, and it puts CSA points on both you and your carrier. A false log is treated as a serious offense, not a paperwork slip. Clean, certified logs are your best defense.",
      },
    ],
    questions: [
      {
      ...
      {
        order: 10,
        question: "You've delivered and the receiver tells you to leave the property. The nearest safe truck stop is 4 miles away, but there's also a shipper 30 miles ahead where you load in the morning. Which move qualifies as personal conveyance?",
        options: ["Driving the 30 miles to stage near tomorrow's shipper", "Driving the 4 miles to the nearest safe rest area", "Either one, since you're running empty", "Neither — PC is never allowed after a delivery"],
        correctIndex: 1,
        explanation: "Moving to the nearest safe rest or parking after being told to leave is genuine personal conveyance. Driving 30 miles to stage near tomorrow's load enhances operational readiness — that advances the business, so it's driving time, not PC. Laden or unladen doesn't change it." },
      {
        order: 11,
        question: "The 16-hour 'big day' exception (49 CFR 395.1(o)) lets a qualifying driver:",
        options: ["Drive up to 16 hours in a day", "Extend the 14-hour window to 16 hours, once every 7 days, when returning to and released at the normal work-reporting location", "Skip the 30-minute break", "Reset the 60/70-hour clock in 16 hours"],
        correctIndex: 1,
        explanation: "The big-day exception extends only the 14-hour WINDOW to 16 hours, once in any 7 days, for a driver who returns to and is released at the same normal work-reporting location. The 11-hour driving limit is unchanged — it is not 16 hours of driving." },
      {
        order: 12,
        question: "You arrive at a shipper on time and wait 3 hours at the dock, available for them to load but free to sit in your cab. How is that time logged?",
        options: ["Off-duty — you weren't doing anything", "On-duty (not driving) — it counts against your 14-hour and 60/70-hour limits", "Personal conveyance", "It doesn't need to be logged at all"],
        correctIndex: 1,
        explanation: "Waiting at a shipper or receiver while available for loading is on-duty (not driving) time, and it burns your 14-hour window and weekly 60/70 total. It is only off-duty if you are relieved of ALL duty and free to leave." },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    summary: "SRL's actual accessorial terms and how to earn them: 2 hours free at each stop then $50/hr detention capped at $250 (arrival-start, appointment-window rule, and the two calls you owe dispatch), $200 TONU and its clearance gate, lumpers fronted by your carrier and reimbursed on the original receipt, plus a clean BOL, POD, and seal under the Carmack Amendment, OS&D and concealed damage, holding the line when you're pressured to sign clean, and the 24-hour paperwork deadline.",
    version: "6",
    estMinutes: 25,
    passThreshold: 80,
    validityMonths: null,
    ...
    lessons: [
      {
        ...
        estMinutes: 4,
        bodyMarkdown:
          "Detention is the time you wait at a shipper or receiver beyond the free time allowed. It is real money, but only if you can prove it. The proof is **timestamps**.\n\nCapture and record:\n\n- Your **arrival time** at the gate or guard shack\n- **Check-in** time at the dock or office\n- **Loaded/unloaded** time and **departure** time\n\nGet these noted on the bill of lading where you can, and back them up with photos of the gate clock, your in-cab clock, or app timestamps. Note times **as they happen**, not from memory at the end of the day.\n\n**What SRL pays, and when the clock starts.** The terms below are **SRL policy**, printed on your rate confirmation. There is no federal detention standard, so do not assume another broker's terms carry over to an SRL load.\n\n- **Free time is 2 hours at every stop.** Each stop gets its own 2 hours. They are separate and they do not add up. Two hours at pickup, two hours at delivery. Time you did not use at pickup does not carry over to delivery.\n- **The clock starts when you ARRIVE.** Not at your appointment time, and not when the dock finally calls you in. Your arrival timestamp is the start of the clock. That is why you log it at the gate.\n- **After free time runs out, detention pays $50 per hour.** Same rate for every trailer type. Dry van and reefer pay the same. There is no tier rate and no equipment rate.\n- **Detention is capped at $250 per stop.** At the cap it converts to **layover at $250 per day**. Detention and layover never both pay for the same hours.\n- **Arrive outside your appointment window and detention does not pay at all.** That covers showing up late, and it covers rolling in hours early and asking to be worked in. Make the appointment.\n\n**Two calls you owe SRL.** Message or call dispatch **30 minutes before detention starts**, which is about 90 minutes after you arrive, and **again when you depart**. Those two calls let SRL work the receiver while you are still sitting there, and they put the wait on record while it is happening. A detention claim that first shows up on the invoice is the hardest kind to collect.\n\n**Not every wait is billable detention.** Sitting at the dock inside your free time is not billable, and neither is a wait on a stop you arrived at outside the window. If you are unsure whether a hold counts, **call dispatch while you are still there**. And do not assume eight hours of sitting means eight hours of detention pay: at $50 an hour against a $250 stop cap, hourly detention at one stop tops out after five billable hours and then becomes layover.\n\n[[figure:detention-timeline]]\n\n> " + TRAINING_DISCLAIMER,
      },
      {
        order: 2,
      ...
      },
      {
        ...
        estMinutes: 5,
        bodyMarkdown:
          "**Accessorials** are charges beyond the line haul: lumper fees, detention, layover, scale tickets, extra stops.\n\n**TONU (Truck Ordered Not Used) pays $200 flat**, and it has a gate. This is **SRL policy**, not a regulation. SRL pays TONU when all three of these were true before the load fell apart:\n\n1. SRL gave you the **pickup number**,\n2. SRL gave you the **shipper address**, and\n3. SRL **cleared you to head to pickup**.\n\nThen SRL or the shipper cancels. If you had already arrived when the cancellation came, you must have arrived **inside the appointment window**.\n\n**Two things TONU does not cover.** It does not pay when **your own carrier** cancels, and it does not pay when the shipper **rejects your trailer as non-compliant** (dirty, odor, damaged, wrong temperature, reefer not running). Those sit on the carrier side.\n\nProtect a real TONU the way you protect anything else: **timestamp and photograph your arrival**, write down **who cancelled and when**, and **call dispatch right away** so it can be billed.\n\n**The receipt is necessary but not enough. Authorization comes first.** The single most common reason a driver eats a charge is that they paid it without getting it approved. **Before you incur any accessorial, text or call dispatch for authorization:** *'Receiver requires a lumper, $185. OK to pay?'* Wait for the yes. A receipt for a charge that was never pre-approved often gets **denied**, and then it comes out of your pocket.\n\n**How a lumper actually gets paid on an SRL load.** **SRL does not issue money codes.** There is no Comchek, no EFS, no Comdata, and no SRL fuel card. Do not sit at the dock waiting on a code, because none is coming. **Your carrier fronts the money, and SRL reimburses on the ORIGINAL RECEIPT.**\n\nIn order:\n\n1. **Get authorization before you pay.** Text or call dispatch and wait for the yes.\n2. **Pay it the way your carrier tells you to.** Ask your own dispatcher how your carrier handles lumpers **before you leave for pickup**. Some carriers issue their own card or code, some want you to pay and expense it. That is your carrier's arrangement to make, not SRL's.\n3. **Get the original receipt and keep it.** SRL reimburses on the original, so the paper itself matters. Photograph it the moment it is in your hand as a backup, but the photo is not the reimbursement.\n4. **Turn the original in** to your carrier the way they want it, and upload the photo with the rest of your paperwork.\n\nThen document it:\n\n- Keep the **lumper receipt**, the **scale ticket**, and the **detention record** separately. Each charge needs its own paper.\n- **Photograph originals immediately** in case the paper gets lost. Full frame, in focus, with the **receipt number and all the text readable**. A blurry photo doesn't get paid.\n- Keep **both** the receipt **and** the dispatch authorization (the text or email saying 'yes').\n\nNo original receipt usually means no reimbursement, and no *authorization* often means no reimbursement either, receipt or not.\n\n[[figure:accessorial-preauth-flowchart]]",
      },
      {
        order: 5,
    ...
    questions: [
      ...
      { order: 2, question: "On an SRL load, free time and detention are:", options: ["a federal standard of two hours at $50 per hour", "2 hours free at each stop, then $50 per hour", "whatever the receiver's posted dock policy says", "higher for reefer than for dry van"], correctIndex: 1, explanation: "SRL gives 2 hours of free time at EVERY stop, then pays detention at $50 per hour, capped at $250 per stop. The rate is the same for every trailer type. These are SRL terms printed on your rate confirmation, not a federal rule. There is no federal detention standard." },
      ...
      { order: 4, question: "On an SRL load, your signed BOL, POD, and supporting paperwork are due:", options: ["within 24 hours of delivery", "within 7 days of delivery", "whenever you next reach a terminal", "only when the office asks for them"], correctIndex: 0, explanation: "SRL's term is 24 hours from delivery, printed on your rate confirmation. It is not a regulation, it is what SRL pays against. It is also the exact window your carrier's Compass Score grades document timeliness on, so late paperwork slows the invoice and marks the scorecard." },
      { order: 5, question: "The receiver requires a $185 lumper. To make sure you get reimbursed, you:", options: ["pay it and keep the receipt, that's all it takes", "text dispatch for authorization BEFORE paying, then keep the original receipt AND the approval", "pay it and mention the amount to dispatch later", "refuse to pay and leave"], correctIndex: 1, explanation: "A receipt alone is necessary but not sufficient. An unauthorized charge often gets denied. Get dispatch's OK first ('lumper $185, OK to pay?'), then keep both the ORIGINAL receipt and the authorization text or email. SRL reimburses on the original." },
      { order: 6, question: "At pickup you sign a clean bill of lading over a pallet that was already crushed. The damage surfaces at delivery. Under the Carmack Amendment, that clean BOL means:", options: ["the shipper automatically eats it", "the freight is presumed to have left the shipper in good condition — so the later damage is presumptively the carrier's problem", "nothing, signatures don't matter", "the receiver is liable because they found it"], correctIndex: 1, explanation: "A clean BOL signed at pickup is prima-facie proof the freight was in good condition at origin (Carmack Amendment, 49 U.S.C. 14706). Sign clean over damage that was already there and the law presumes it left fine, so the carrier owns the later claim. A clean POD at delivery is the opposite — it protects the carrier. Note the exception before you sign." },
      ...
      { order: 9, question: "SRL dispatch approves a $200 lumper. How does it get paid?", options: ["SRL issues you a Comchek or EFS code at the dock", "your carrier fronts it, and SRL reimburses on the original receipt", "SRL pays the receiver directly", "the receiver waives it once SRL approves"], correctIndex: 1, explanation: "SRL does not issue money codes. There is no Comchek, EFS, Comdata, or SRL fuel card, so waiting at the dock for a code strands you and the load. Your carrier fronts the cost and SRL reimburses on the ORIGINAL receipt. Get the authorization first, ask your own carrier how they want lumpers paid before you leave for pickup, and keep the original." },
      { order: 10, question: "A shipper hands you 20 sealed, banded cases you can't open, and asks you to sign for the piece count inside them. On the BOL you should:", options: ["sign for the full piece count as if you verified it", "note 'per shipper count' / STC (said to contain) so you're not attesting to a count you couldn't verify", "refuse the load", "cross out the piece count entirely"], correctIndex: 1, explanation: "You can count the sealed cases, but not the pieces sealed inside them. Writing 'per shipper count' or 'STC' (said to contain) means you acknowledge the shipper's number without attesting to a count you had no way to verify — so a later shortage inside the sealed cases isn't automatically on you." },
      { order: 11, question: "You have a 14:00 delivery appointment and arrive at 13:50, inside the window. The receiver doesn't get to you until 18:00. Your detention clock started at:", options: ["14:00, the appointment time", "13:50, when you arrived", "18:00, when they started working you", "when you first called dispatch about the wait"], correctIndex: 1, explanation: "SRL measures detention from ARRIVAL, not from the appointment and not from when the dock finally gets to you. Your 2 hours of free time run 13:50 to 15:50, so billable detention starts at 15:50. Arriving inside the appointment window is what keeps it payable at all: arrive outside the window, early or late, and detention does not pay. Message dispatch 30 minutes before detention starts (15:20 here) and again when you depart." },
      { order: 12, question: "You sit at one stop long enough to run past the $250 detention cap. What happens next?", options: ["detention keeps accruing at $50 per hour with no ceiling", "detention converts to layover at $250 per day, and the two never both pay for the same hours", "detention and layover both accrue from that point", "nothing further is payable at that stop"], correctIndex: 1, explanation: "Detention is capped at $250 per stop, which is five billable hours at $50. At the cap it converts to layover at $250 per day. They never stack for the same hours. The cap and the layover day rate are set equal on purpose so a long hold never leaves you earning nothing while you sit." },
      { order: 13, question: "SRL gave you the pickup number and the shipper address and cleared you to head to pickup. You arrive inside the appointment window and the shipper cancels. You are owed:", options: ["nothing, because you never loaded", "TONU, $200 flat", "detention at $50 per hour until you leave", "the full line haul"], correctIndex: 1, explanation: "TONU is $200 flat. It pays when SRL gave you the pickup number AND the shipper address AND cleared you to head to pickup, and then SRL or the shipper cancels. If you had already arrived, you had to be inside the appointment window. TONU does not pay when your own carrier cancels, or when the shipper rejects your trailer as non-compliant." },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    category: "SRL Operational Excellence",
    summary: "How double-brokering and freight scams leave carriers unpaid, carrier identity theft, the red flags (including look-alike domains, chameleon carriers, and fake insurance), factoring and the Notice of Assignment, how to verify a broker before you commit, where to report, and why no load is worth skipping the check.",
    version: "5",
    estMinutes: 20,
    passThreshold: 80,
    validityMonths: null,
    ...
    questions: [
      ...
      { order: 8, question: "Besides being scammed by a fake broker, a carrier can also be the victim of:", options: ["nothing — fraud only targets brokers", "identity theft, where a fraudster uses your MC/DOT and name to grab loads or redirect payments", "a clean inspection", "a Compass Score bonus"], correctIndex: 1, explanation: "Fraudsters steal a legitimate carrier's identity — MC/DOT, name, even its insurance certificate — to pose as them. Guard your credentials, don't share portal logins, and watch for activity under your authority you didn't initiate." },
      { order: 9, question: "You get an email — from what looks like your broker's address — saying the remit-to bank account has changed and to update it before your next payment. You:", options: ["update it right away so you don't miss the payment", "reply to the email to confirm, then update it", "verify the change by calling a known, independently-sourced contact at the company — not a number or email from the message", "ignore every future payment from them"], correctIndex: 2, explanation: "Payment-redirect fraud rides on banking-change emails, fake NOAs, and look-alike domains (silkroute-logistics.ai vs the real silkroutelogistics.ai). Never act on the contact info in the message itself — confirm any banking or NOA change through a phone number or email you independently look up. Replying to the email just talks to the scammer." },
    ],
  },
];
