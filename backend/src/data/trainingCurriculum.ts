...
You are responsible for selecting the correct duty status: off duty, sleeper berth, driving, or on-duty-not-driving. The device records the driving; you annotate the rest. Review and certify your logs daily.`,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      { order: 5, question: "You paid a lumper at the dock. To be reimbursed you must:", options: ["submit the lumper receipt", "tell dispatch the amount", "log it on your ELD", "nothing — it is automatic"], correctIndex: 0, explanation: "Accessorials each need their own paper. No receipt usually means no reimbursement, so keep and submit it." },
    ],
  },
