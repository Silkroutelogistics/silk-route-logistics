...
export const CURRICULUM: CurriculumCourse[] = [
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    questions: [
      {
        order: 1,
        question: "In a double-brokering scam, why does the carrier that hauled the load go unpaid?",
        options: [
          "The shipper went bankrupt",
          "An unauthorized party re-brokered the load, collected the pay, and disappeared",
          "The driver missed the delivery window",
          "The fuel surcharge was miscalculated",
        ],
        correctIndex: 1,
        explanation: "A fraudulent party re-brokers the load and pockets the payment, leaving the actual hauling carrier with no one legitimate to collect from.",
      },
      {
        order: 2,
        question: "Which of these is a classic fraud red flag?",
        options: [
          "A rate that matches the market",
          "A last-minute emailed request to change the remit-to/banking information",
          "A broker who answers verification questions",
          "A signed rate confirmation",
        ],
        correctIndex: 1,
        explanation: "An unsolicited request to change payment/banking details, especially by email, is a classic payment-redirect fraud.",
      },
      {
        order: 3,
        question: "The best way to confirm a broker's phone contact is genuine is to:",
        options: [
          "Call the number in the load offer email",
          "Trust the load board listing",
          "Call the number listed on the official FMCSA record",
          "Ask another driver",
        ],
        correctIndex: 2,
        explanation: "Spoofed contacts pair a real company name with a fake number. Call the number on the FMCSA record, not the one in the email.",
      },
      {
        order: 4,
        question: "What should you check to verify a broker before hauling?",
        options: [
          "Only that the rate is high",
          "Active USDOT and broker authority in good standing on FMCSA SAFER, plus a BMC-84 bond on file",
          "That they have a nice website",
          "Nothing, brokers are always legitimate",
        ],
        correctIndex: 1,
        explanation: "Look the broker up on FMCSA SAFER by USDOT number, confirm the broker authority is active and in good standing with a BMC-84 bond, and that the contracting company matches who will pay you.",
      },
      {
        order: 5,
        question: "You suspect a load on the SRL platform is a double-brokering attempt. You should:",
        options: [
          "Haul it anyway and sort it out later",
          "Stop, verify, and report it to compliance@silkroutelogistics.ai",
          "Change your banking info as requested",
          "Ignore it",
        ],
        correctIndex: 1,
        explanation: "Stop, verify the broker, and report suspected fraud to SRL compliance so the load can be protected and other carriers warned.",
      },
    ],
  },
];
