...
Look **far ahead**, keep an **escape path** to the side, and never let a four-wheeler crowd you into having no room. Space is the cushion that turns an emergency into a near miss.`,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    summary: "Why load visibility is part of the job, how to stay visible on an SRL load (including connecting ELD/telematics), what to do when tracking drops, and how tracking and check calls feed your carrier's SRL Compass Score.",
    version: "4",
    estMinutes: 17,
    passThreshold: 80,
    validityMonths: null,
