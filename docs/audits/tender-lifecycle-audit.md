...
| 10 | BOL + shipper notify at CONFIRMED | PARTIAL **v3.8.axv** — the carrier's BOL download now requires a CONFIRMED tender (AE exempt, since they arrange the signature). Shipper fan-out still fires at accept | Fan-out move = 11e |
